/*
Скрипт развертывания для Countries
...
GO
:setvar DatabaseName "Countries"
:setvar DefaultFilePrefix "Countries"
...
GO
PRINT N'Выполняется создание [dbo].[FK_Countries_Regions]...';


GO
ALTER TABLE [dbo].[Countries]
    ADD CONSTRAINT [FK_Countries_Regions] FOREIGN KEY ([Region]) REFERENCES [dbo].[Regions] ([Id]);


GO
PRINT N'Выполняется создание [dbo].[FK_Countries_ToTable]...';


GO
ALTER TABLE [dbo].[Countries]
    ADD CONSTRAINT [FK_Countries_ToTable] FOREIGN KEY ([Capital]) REFERENCES [dbo].[Cities] ([Id]);
